    ...
    <footer className="w-full py-5 md:py-12 px-4 mt-8 md:mt-12 border-t border-primary/20 bg-muted/30 pb-2 md:pb-12">
      <div className="max-w-4xl mx-auto flex flex-col items-center justify-center gap-3 md:gap-6">
        ...
        <div className="flex items-center gap-2 mt-[-4px] mb-2">
          <span className="text-[11px] text-muted-foreground/60 font-sans">Official Site of</span>
          <Link 
            href="https://in.pinterest.com/sahil620476" // Replace 'contenthub' with your exact username if different
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 bg-[#E60023]/10 hover:bg-[#E60023]/15 text-[#E60023] font-sans text-[11px] font-bold px-3 py-1 rounded-full border border-[#E60023]/15 transition-all duration-300 hover:scale-[1.03]"
          >
